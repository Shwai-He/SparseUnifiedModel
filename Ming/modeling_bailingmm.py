...
class BailingMMNativeForConditionalGeneration(PreTrainedModel):
    ...
    def __init__(
        ...
        #     print(f"self.config.audio_config: {self.config.audio_config}")
        #     print(f"self.config.audio_config.whisper_encoder_config: {self.config.audio_config.whisper_encoder_config}")
    ...
    def generate(
        ...
        **generate_kwargs,
        ...
        if image_gen:
            ...
            condition_embeds, attentions = self.get_condition_embeds_for_image_gen( #####
                input_ids=input_ids, 
                attention_mask=attention_mask,
            ...
            # negative_condition_embeds, attentions = self.get_condition_embeds_for_image_gen(
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        if load_image_gen:
            # pass
            # print(f"load image gen modules from {pretrained_model_name_or_path}")
            # print(model)
    ...
    def get_condition_embeds_for_image_gen(
        ...
        with torch.cuda.amp.autocast(dtype=torch.bfloat16):
            ...
            return scale_embeds, attentions
