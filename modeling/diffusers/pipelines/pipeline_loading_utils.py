...
def load_sub_model(
    ...
    # if "text_encoder" in name:
        # from .qwenimage.modeling_qwen2_5_vl import Qwen2_5_VLForConditionalGeneration
        # load_method = Qwen2_5_VLForConditionalGeneration
    print(f"{name} load_method: {load_method} | dduf_entries: {dduf_entries}")
    ...
    if dduf_entries:
        ...
        # print(f"name: {name} | loading_kwargs: {loading_kwargs}")
