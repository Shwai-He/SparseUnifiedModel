...
def load_model_and_tokenizer(args):
    ...
    llm_config.transformed_und = False
    llm_config.transformed_gen = False

    num_experts = args.num_experts if hasattr(args, "num_experts") else None
    num_shared_experts = args.num_shared_experts if hasattr(args, "num_shared_experts") else None
