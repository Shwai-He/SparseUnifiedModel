...
def fewshot_compress(keep_ratio, compressed_layers_und, compressed_layers_gen, calibration_samples): 
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out-dir', type=str, default='/mnt/bn/seed-aws-va/shwai.he/cdt-hf/results/understanding/MMMU')
    ...
    if args.keep_ratio < 1.0:
        ...
        fewshot_compress(args.keep_ratio, compressed_layers_und, compressed_layers_gen, calibration_samples)
